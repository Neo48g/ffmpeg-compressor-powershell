...
- **️ One-Click FFmpeg Setup**: Includes a script to automatically download, extract, and add the **Full GPL version** of FFmpeg (with all libraries like x264, x265, AV1, VMAF) to your system PATH.
